        ...
        <div className={classes.how_Full} data-aos="fade-up">
          ...
          <div className={classes.how}>
            ...
            <p>
              ...
              directly through our platform with just a few clicks.
            </p>
          </div>
        </div>
        <div className={classes.how_Full} data-aos="fade-up">
          <div className={classes.how}>
            ...
            <p>
              Keep track of your job applications with ease and receive
          ...
          <div className={classes.how}>
            ...
            <p>
              Once your application is submitted, sit back and relax as we
              review your qualifications and connect you with schools that are
              interested un your profile.
            </p>
          </div>
          <div className={classes.how}>
            <div className={classes.circle}>
